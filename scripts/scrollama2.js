...
function handleStepEnter2(response) {
	...
	if (response.index=="0"){
		document.getElementById('main2').innerHTML = '<img src="images/drapeautunisie.png" alt="Drapeau tunisien">'	
	}
	if (response.index=="1"){
		document.getElementById('main2').innerHTML = '<img src="images/drapeaumaroc.png" alt="Drapeau marocain">'	
	}

	if (response.index=="2"){
		document.getElementById('main2').innerHTML = '<img src="images/drapeaujordanie.png" alt="Drapeau jordanien">'	
	}

	if (response.index=="3"){
		document.getElementById('main2').innerHTML = '<img src="images/drapeauegypte.png" alt="Drapeau égyptien">'	
	}
}
