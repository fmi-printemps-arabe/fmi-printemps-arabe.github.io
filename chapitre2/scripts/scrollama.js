...
function handleStepEnter(response) {
	...
	document.getElementById('main').innerHTML = ('<img style="filter:grayscale(1) blur('+(response.index+1)*2+'px)" src="images/FMI.jpg" alt="Femme dans des manifestations contre le FMI, Egypte" />');            
}
